const aboutData = {
    ...
    biodata: [
        ...
        { label: "Date of Birth", value: "August,04-1999", icon: "bx bx-calendar" },
        { label: "Place of Birth", value: "Vung Tau, Vietnam", icon: "bx bx-map" },
        { label: "Email", value: "bmhieu481999@gmail.com", icon: "bx bx-envelope" },
        { label: "Phone", value: "+84 349 647 104", icon: "bx bx-phone" },
        { label: "Education", value: "University of Technology", icon: "bx bx-book" },
